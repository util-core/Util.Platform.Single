...
/// 用户服务
/// </summary>
public class UserService : UserServiceBase<IPlatformUnitOfWork, User, Role, UserDto, CreateUserRequest, UserQuery>, IUserService {
    /// <summary>
    /// 初始化用户服务
    /// </summary>
    ...
    public UserService( IServiceProvider serviceProvider, IPlatformUnitOfWork unitOfWork, IUserRepository userRepository, IUserManager userManager )
