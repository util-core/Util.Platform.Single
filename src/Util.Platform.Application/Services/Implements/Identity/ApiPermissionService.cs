...
/// Api权限服务
/// </summary>
public class ApiPermissionService : ApiPermissionServiceBase<ISystemUnitOfWork, Permission, Resource, Application, User, Role, ApiResourceDto, PermissionRequest>, IApiPermissionService {
    /// <summary>
    /// 初始化Api权限服务
    /// </summary>
    ...
    public ApiPermissionService( IServiceProvider serviceProvider, ISystemUnitOfWork unitOfWork, IPermissionRepository permissionRepository,
