namespace Util.Platform.Data.SqlServer.Tests.Repositories.Identity;
...
public class ApplicationRepositoryTest {
    ...
    /// 测试初始化
    /// </summary>
    public ApplicationRepositoryTest( ISystemUnitOfWork unitOfWork, IApplicationRepository repository ) {
